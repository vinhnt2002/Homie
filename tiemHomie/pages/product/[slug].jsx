...
const ProductDetail = ({ product,products,categories }) => {
  ...
  // console.log([cateCodeObject[0]]);
  

  // console.log([cateCodeObject[0].category.name]);
  // console.log(cateCodeObject[0].category.code);
    ...
    >
     <div className="d-flex">
      ...
      <div id="fcta-zalo-tracking" className="fcta-zalo-mess">
        <span id="fcta-zalo-tracking">Liên lạc để mua hàng nhanh chóng nhé !</span>
      </div>
     </div>
    </a>
    <style
