            ...
            <div className={Styles.downClass}>
              ...
              <div className="product_price">
                <div className="">
                  ...
                  {showSaleOfprice && (
                    <del className="">
                      {formatPrice(productData.minPrice !== null ? productData.minPrice : productData.price)} VND
                    </del>
                  )}
                </div>
                <div className="on_sale">
                  {showSaleOfprice && (
                    <span>{productData.price} Off</span>
                    // <span>{product.minPrice !== Infinity ? product.minPrice : product.price}</span>
                  )}
                </div>
              </div>
